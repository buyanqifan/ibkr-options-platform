...
class BinbinGodParityConfig:
    ...
    def from_params(cls, params: Dict[str, Any]) -> "BinbinGodParityConfig":
        ...
        return cls(
            ...
            sp_primary_delta_tolerance=_clamp(
                _to_float(merged.get("sp_primary_delta_tolerance", QC_BINBIN_DEFAULTS["sp_primary_delta_tolerance"]),
                QC_BINBIN_DEFAULTS["sp_primary_delta_tolerance"]),
                0.04,
                0.40
            ),
